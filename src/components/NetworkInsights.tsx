...
export function NetworkInsights({ nodes }: NetworkInsightsProps) {
  ...
  return (
    <Card className="border-2 border-cyan-500/20 bg-gradient-to-br from-cyan-500/5 to-background">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <Badge variant="outline" className="gap-1 border-cyan-500/20">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div className="p-3 bg-cyan-500/10 border border-cyan-500/20 rounded-lg">
            ...
            <div className="text-2xl font-bold text-cyan-500">{insights.avgHealth}%</div>
        ...
        {/* Summary Insight */}
        <div className="p-3 bg-muted/50 rounded-lg border border-cyan-500/10">
          <div className="flex items-start gap-2">
            <ArrowUp className="h-4 w-4 text-cyan-500 mt-0.5 flex-shrink-0" />
        ...
        <div className="grid grid-cols-3 gap-2 pt-2 border-t border-cyan-500/10">
          <div className="text-center">
            <div className="text-lg font-bold text-cyan-500">{insights.onlineNodes}</div>
            <div className="text-[10px] text-muted-foreground">Online Now</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-bold text-cyan-500">{insights.avgHealth}%</div>
            <div className="text-[10px] text-muted-foreground">Avg Health</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-bold text-cyan-500">+{insights.growthRate}%</div>
